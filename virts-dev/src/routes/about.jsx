export default function About() {
  return (
    <div className="container">
      ...
      <p>
        I have had the opportunity to work on a diverse range of projects, from
        small business websites to large-scale web applications. I am highly
        collaborative and enjoy working with a team, but am also comfortable
        taking on individual projects and seeing them through to completion.
      </p>

      <h3>Non-Profit</h3>
      <small>Worked/volunteered with Young Life for 10 years</small>
      <p>
        In addition to my technical skills, I have excellent problem-solving and
        communication skills, which have proven to be valuable assets in my
